...
# 	output_s2 = (output_s2**k).mean(0)
# 	output_t = (output_t**k).mean(0)
# 	return  euclidean(output_s1, output_t) + euclidean(output_s2, output_t) + \
# 		euclidean(output_s1, output_s2)
...
# 	moment1 = euclidean(output_s1, output_t) + euclidean(output_s2, output_t)+\
# 		euclidean(output_s1, output_s2)
# 	reg_info = moment1
# 	#print(reg_info)
